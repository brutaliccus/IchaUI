-- IchaPlates: compat/vanilla.lua (ported from ShaguPlatesX compat/vanilla.lua).
...
if IchaPlates.expansion ~= "vanilla" then return end
...
function hooksecurefunc(name, func, append)
  ...
  IchaPlates.hooks[tostring(func)] = {}
  IchaPlates.hooks[tostring(func)]["old"] = _G[name]
  IchaPlates.hooks[tostring(func)]["new"] = func

  if append then
    IchaPlates.hooks[tostring(func)]["function"] = function(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
      IchaPlates.hooks[tostring(func)]["old"](a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
      IchaPlates.hooks[tostring(func)]["new"](a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
    end
  else
    IchaPlates.hooks[tostring(func)]["function"] = function(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
      IchaPlates.hooks[tostring(func)]["new"](a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
  ...
  _G[name] = IchaPlates.hooks[tostring(func)]["function"]
end
