-- IchaPlates locale data (deDE): critters, totems and debuff durations.
-- Ported from ShaguPlatesX (env/locales_deDE.lua).
...
IchaPlates_locale["deDE"] = {}

IchaPlates_locale["deDE"]["critters"] = {
  'Otter',
  'Käfer',
  'Turmfledermaus',
  'Gallkröte',
...
IchaPlates_locale["deDE"]["debuffs"] = {
  ['AE Charm']={[0]=300.0,},
...
IchaPlates_locale["deDE"]["debuffs"]['Kältekegel']={[0]=8.0,} -- Cone of Cold

IchaPlates_locale["deDE"]["totems"] = {
