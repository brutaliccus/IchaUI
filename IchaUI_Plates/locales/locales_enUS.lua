-- IchaPlates locale data (enUS): critters, totems and debuff durations.
-- Ported from ShaguPlatesX (env/locales_enUS.lua).
...
IchaPlates_locale["enUS"] = {}

IchaPlates_locale["enUS"]["critters"] = {
  'Adder',
  'Beetle',
  'Belfry Bat',
  'Biletoad',
...
IchaPlates_locale["enUS"]["debuffs"] = {
  ['AE Charm']={[0]=300.0,},
...
IchaPlates_locale["enUS"]["debuffs"]['Cone of Cold']={[0]=8.0,} -- Cone of Cold

IchaPlates_locale["enUS"]["totems"] = {
