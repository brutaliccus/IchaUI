-- IchaPlates locale data (frFR): critters, totems and debuff durations.
-- Ported from ShaguPlatesX (env/locales_frFR.lua).
-- ShaguPlatesX: Copyright (c) 2016-2021 Eric Mauser (Shagu), adapted by Ehawne. MIT License,
-- see LICENSE-ShaguPlates.txt. pfUI-derived data.
if GetLocale() ~= "frFR" then return end

IchaPlates_locale["frFR"] = {}

IchaPlates_locale["frFR"]["critters"] = {
  'Aspic',
  'Hanneton',
...
IchaPlates_locale["frFR"]["debuffs"] = {
  ['AE Charme']={[0]=300.0,},
...
IchaPlates_locale["frFR"]["debuffs"]['Cône de froid']={[0]=8.0,} -- Cone of Cold

IchaPlates_locale["frFR"]["totems"] = {
