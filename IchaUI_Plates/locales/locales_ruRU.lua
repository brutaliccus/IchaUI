-- IchaPlates locale data (ruRU): critters, totems and debuff durations.
-- Ported from ShaguPlatesX (env/locales_ruRU.lua).
...
IchaPlates_locale["ruRU"] = {}

IchaPlates_locale["ruRU"]["critters"] = {
  'Аспид',
  'Жук',
  'Чердачный нетопырь',
  'Желчная жаба',
...
IchaPlates_locale["ruRU"]["debuffs"] = {
  ['"Дар Артаса"']={[0]=180.0,},
...
IchaPlates_locale["ruRU"]["debuffs"]['Конус холода']={[0]=8.0,} -- Cone of Cold

IchaPlates_locale["ruRU"]["totems"] = {
