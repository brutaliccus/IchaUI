-- IchaPlates: modules/cooldown.lua (ported from ShaguPlatesX modules/cooldown.lua).
...
IchaPlates:RegisterModule("cooldown", "vanilla", function ()
  -- cache values
  ...
  local function pfCreateCoolDown(cooldown, start, duration)
    ...
    cooldown.pfCooldownText:SetFrameLevel(cooldown:GetParent():GetFrameLevel() + (cooldown.pfCooldownTextLevel or 1))
  ...
  local function SetCooldown(this, start, duration, enable)
    ...
    -- disable GCDs on non IchaPlates frames
