...
2. Exit WoW.
3. Extract it into `World of Warcraft\Interface\AddOns\`. You should see folders like `AddOns\IchaUI`, `AddOns\IchaUI_Bars` and so on, not `AddOns\IchaUI-3.3.0\IchaUI`.
